...
CREATE TABLE TELEFONO(
	TELEFONO_ID INT(8) NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
DELIMITER $$
CREATE TRIGGER BEFORE_INSERT_TELEFONO
...
DELIMITER $$
CREATE TRIGGER BEFORE_UPDATE_TELEFONO
  BEFORE UPDATE ON PROGRA_2.TELEFONO FOR EACH ROW
BEGIN
