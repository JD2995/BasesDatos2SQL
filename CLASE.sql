CREATE TABLE CLASE(
	CLASE_ID INT(8) NOT NULL AUTO_INCREMENT PRIMARY KEY,
    NOMBRE VARCHAR(30),
    FEC_CREACION DATE,
...
DELIMITER $$
CREATE TRIGGER BEFORE_INSERT_CLASE
...
DELIMITER $$
CREATE TRIGGER BEFORE_UPDATE_CLASE
  BEFORE UPDATE ON PROGRA_2.CLASE FOR EACH ROW
BEGIN
