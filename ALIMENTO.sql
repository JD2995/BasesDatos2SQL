...
CREATE TABLE ALIMENTO(
	ALIMENTO_ID INT(8) NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
DELIMITER $$
CREATE TRIGGER BEFORE_INSERT_ALIMENTO
  BEFORE INSERT ON ALIMENTO FOR EACH ROW
BEGIN
...
DELIMITER $$
CREATE TRIGGER BEFORE_UPDATE_ALIMENTO
  BEFORE UPDATE ON PROGRA_2.ALIMENTO FOR EACH ROW
BEGIN
